...
export function HeaderSmallTop() {
  // pop up state - visibility
  ...
  return (
    <div id="header-small-top">
      ...
      <div id="header-small-profile-container">
...
export function HeaderSmallBottom() {
  const [active, setActive] = useState("");
  if (window.location.href === "/") {
    setActive("1");
  } else if (window.location.href === "/explore") {
    setActive("2");
  } else if (window.location.href === "/bookmarks") {
    setActive("3");
  }
  const onClickHandler = (event) => {
    // update $active state from 'data-id' attribute
    setActive(event.target.dataset.id);
  };
  return (
    <div id="header-small-bottom">
      <Link
        to="/"
